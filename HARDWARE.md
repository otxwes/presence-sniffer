...
| 2 | Raspberry Pi 5 (**2GB or 4GB** — not 1GB) + official 27W PSU + official Active Cooler + 32GB+ A1 microSD — **bought separately from an MSRP reseller (Adafruit / PiShop / Vilros), NOT a CanaKit starter-kit bundle** | $110–125 | aggregator host | Requires **5V/5A (25W)** PD supply, else USB budget caps at 600 mA. Kit-bundle math (verified 2026-09-19 canakit.com): their Turbine starter kits are $149.95 (1GB) / $159.95 (2GB) / $204.95 (4GB) — bundle mark-up over MSRP piecemeal (~$110–125 total incl. cooler+PSU+SD) buys a case+2×HDMI+card reader that our custom printed enclosure and headless deployment make worthless. 2GB is comfortable for the asyncio aggregator; 4GB = headroom |
