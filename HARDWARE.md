...
| 2 | Raspberry Pi 5 **4GB** board-only + official CanaKit 5A/27W USB-C PD PSU + official Active Cooler (confirmed in-stock alternative: CanaKit fan or Mega Heat Sink works for bench phase) + 32GB+ A1 microSD (Amazon) | $110 + $14.95 + ~$13 + ~$10 ≈ **$148** | aggregator host | Requires **5V/5A (25W)** PD supply, else USB budget caps at 600 mA. Vendor decision (2026-09-19): Vilros still cheapest on PSU ($14.46) + Active Cooler ($11.95), but **Pi 5 4GB board-only sold out there** — CanaKit 4GB board-only $110 is the cheapest in-stock 4GB (Adafruit 4GB $130, PiShop/other 8GB $175). Keeping board+PSU+cooler in one CanaKit order conserves shipping; roughly $148 total, within the $260–315 rig envelope |
