...
| 4 | RTL-SDR Blog — **V4L (Lite), dongle-only** | **$37.95** | [rtl-sdr.com/buy-rtl-sdr-dvb-t-dongles](https://www.rtl-sdr.com/buy-rtl-sdr-dvb-t-dongles/) (direct, free ship; do NOT buy Amazon "V4" clones like SBJKBVMF — wrong tuner R828D, 3rd-party brand) | Same RF core as full V4 (R828S/RTL2832U, 1PPM TCXO, SMA, bias-tee); Lite = no bundled antenna kit, which we don't need (custom enclosure, own antenna plumbing). Latest release — slightly newer than V4, current Pi OS drivers fine. Regular V4 (~$45 bundled) is the fallback if you want max driver maturity |
